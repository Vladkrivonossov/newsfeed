describe('Админка', () => {
  ...
  it('Создание статьи', () => {
    ...
    cy.get(':nth-child(4) > .MuiFormControl-root > .MuiOutlinedInput-root').type(
      'Test cypress Test cypress Test cypress Test cypress Test cypress Test cypress Test cypress Test cypress Test cypress Test cypress Test cypress Test cypress Test cypress Test cypress Test cypress Test cypress '
    );
